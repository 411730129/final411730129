...
function preload() {
  ...
  player1Images.idle = loadImage('10.png');
  player1Images.walkLeft = loadImage('12.png');
  player1Images.walkRight = loadImage('11.png');
  player1Images.jump = loadImage('13.png');

  player2Images.idle = loadImage('22.png');
  player2Images.walkLeft = loadImage('22.png');
  player2Images.walkRight = loadImage('20.png');
  player2Images.jump = loadImage('23.png');

  bulletImage = loadImage('zidan.png');
  bulletImageLeft = loadImage('zidan1.png');
}
...
function draw() {
  ...
  textSize(32);
  fill(255);
  text("淡江教科", width / 2 - 100, height / 2 - 200);
